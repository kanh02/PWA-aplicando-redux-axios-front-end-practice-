...
function parseSource(source, opt, documentation) {
    return __awaiter(this, void 0, void 0, function () {
        var singleFileComponent, docs, addScriptHandlers;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, parseSFC(documentation, source, opt)];
                case 1:
                    docs = [_a.sent()];
                    return [3 /*break*/, 4];
                case 2:
                    ...
                    return [4 /*yield*/, parse_script_1.default(source, script_handlers_1.preHandlers, __spreadArrays(script_handlers_1.default, addScriptHandlers), opt, documentation)];
                case 3:
                    docs =
                        (_a.sent()) || [];
...
function parseSFC(initialDoc, source, opt) {
    return __awaiter(this, void 0, void 0, function () {
        var addScriptHandlers, documentation, parts, docsBlocks, extTemplSrc, extTemplSource, _a, addTemplateHandlers, extSrc, extSource, _b, scriptSource;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 7:
                    ...
                    return [4 /*yield*/, parse_script_1.default(scriptSource, script_handlers_1.preHandlers, __spreadArrays(script_handlers_1.default, addScriptHandlers), opt, documentation)];
                case 8:
                    _c.sent();
                    _c.label = 9;
                case 9:

...
function parseScript(source, preHandlers, handlers, options, documentation) {
    return __awaiter(this, void 0, void 0, function () {
        var plugins, ast, componentDefinitions;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    componentDefinitions = resolveExportedComponent_1.default(ast);
                    if (componentDefinitions.size === 0) {
                        throw new Error(ERROR_MISSING_DEFINITION + " on \"" + options.filePath + "\"");
                    }
                    return [4 /*yield*/, executeHandlers(preHandlers, handlers, componentDefinitions, documentation, ast, options)];
...
function executeHandlers(preHandlers, localHandlers, componentDefinitions, documentation, ast, opt) {
    return __awaiter(this, void 0, void 0, function () {
        var compDefs;
        var _this = this;
        return __generator(this, function (_a) {
                ...
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all(compDefs.map(function (name) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        doc = documentation || new Documentation_1.default();

...
function mixinsHandler(documentation, componentDefinition, astPath, opt) {
    return __awaiter(this, void 0, void 0, function () {
        var originalDirName, pathResolver, mixinVariableNames, mixinVarToFilePath, files, _loop_1, _i, _a, varName;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, adaptExportsToIEV_1.default(pathResolver, mixinVarToFilePath, opt.validExtends)
                ...
                case 1:
                    ...
                    _loop_1 = function (varName) {
                        var _a = mixinVarToFilePath[varName], filePath = _a.filePath, exportName = _a.exportName;
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        return [4 /*yield*/, parse_1.parseFile(__assign(__assign({}, opt), { filePath: fullFilePath, nameFilter: vars, mixin: mixinVar }), documentation)];
                                    case 3:
                                        _a.sent();

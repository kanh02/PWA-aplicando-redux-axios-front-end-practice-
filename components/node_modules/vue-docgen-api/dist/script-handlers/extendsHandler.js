...
function extendsHandler(documentation, componentDefinition, astPath, opt) {
    return __awaiter(this, void 0, void 0, function () {
        var extendsVariableName, extendsFilePath, originalDirName, pathResolver;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, adaptExportsToIEV_1.default(pathResolver, extendsFilePath, opt.validExtends)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, extendsFilePath[extendsVariableName].filePath.reduce(function (_, p) { return __awaiter(_this, void 0, void 0, function () {
                            var fullFilePath, extendsVar, e_1;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, parse_1.parseFile(__assign(__assign({}, opt), { filePath: fullFilePath, nameFilter: [extendsFilePath[extendsVariableName].exportName], extends: extendsVar }), documentation)];
                                    case 2:
                                        _a.sent();
